...
class Configs:
    """
    A class used to wrap config from a config file for einkframe.
    ...
    def backup_config(self):
        ...
        self.config_path = FileOperations.backup_file(self.config_path)
    ...
    def write_config(self, new_path):
        ...
        logging.info(f"Conwfig written to {new_path}")
        return
